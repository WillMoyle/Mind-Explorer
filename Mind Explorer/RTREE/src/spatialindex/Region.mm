...
Region::Region(const PointObj& low, const PointObj& high)
{
...
void Region::getCenter(PointObj& out) const
{
...
bool Region::containsPoint(const PointObj& p) const
{
...
bool Region::touchesPoint(const PointObj& p) const
{
	if (m_dimension != p.m_dimension)
		throw Tools::IllegalArgumentException(
...
double Region::getMinimumDistance(const PointObj& p) const
{
	if (m_dimension != p.m_dimension)
		throw Tools::IllegalArgumentException(
...
void Region::combinePoint(const PointObj& p)
{
	if (m_dimension != p.m_dimension)
		throw Tools::IllegalArgumentException(

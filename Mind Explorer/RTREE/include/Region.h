...
namespace SpatialIndex
{
	...
	public:
		...
		Region(const PointObj& low, const PointObj& high);
		...
		virtual bool containsPoint(const PointObj& in) const;
		virtual bool touchesPoint(const PointObj& in) const;
		virtual double getMinimumDistance(const PointObj& in) const;
		...
		virtual void combinePoint(const PointObj& in);

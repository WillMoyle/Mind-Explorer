...
namespace SpatialIndex
{
	...
	public:
		...
		virtual void getCenter(PointObj& out) const = 0;
	...
	public:
		...
		virtual void seedKNN(const PointObj& query, IVisitor& v) {};
		virtual void pointLocationQuery(const PointObj& query, IVisitor& v) = 0;
...
#include "../src/spatialindex/SpatialIndexImpl.h"
#include "Point.h"
#include "Region.h"
